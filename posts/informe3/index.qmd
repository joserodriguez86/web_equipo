...
```
Otra forma de observar el derrotero de la pobreza es analizar la distancia que presentan las personas respecto a la línea que establece qué hogar es o no pobre. De este modo, la @fig-distancia muestra una estratificación de la sociedad según cuán distantes están las personas de la canasta básica de pobreza. Así, en amarillo, encontramos a las personas que presentan ingresos familiares que duplican el valor de la canasta y que fueron descendiendo a lo largo de los años, alcanzando el valor de 27% a fines de 2024. Por el contrario, los valores más oscuros (negros y violetas) definen a las personas que se encuentran por debajo de la canasta básica total (CBT) y que aumentaron fuertemente a comienzos de 2024 y, posteriormente, retornaron a los niveles anteriores. 
...
#| fig.cap: "Evolución de la pobreza según categoría ocupacional. Argentina urbana, 2016-2024 (Anual)"
...
#| fig.cap: "Evolución de la pobreza en mayores de 65 años. Argentina urbana, 2016-2024 (Anual)"
#| label: fig-mayores
...
#| fig.cap: "Variación % de los ingresos laborales según rama de actividad (en naranja ramas con mayor peso poblacional). Argentina urbana, 2023-III / 2024-IV (trimestres). Población ocupada mayor a 18 años."
...
#| fig.cap: "Mediana de ingresos laborales según rama de actividad (en naranja ramas con mayor peso poblacional). Argentina urbana, 2024-IV (trimestres). Población ocupada mayor a 18 años."
...
#| fig.cap: "Estrategias económicas familiares. Argentina urbana, 2016-2024 (Anual)."
#| label: fig-ahorros
...
tabla %>% 
  ...
  geom_line(size = .7) +
  geom_point(size = 1.5) +
  geom_text(data = . %>% filter(ANO4 %in% c("2016", "2023", "2024")),
            aes(label = scales::percent(n, accuracy = 0.1)), 
            size = 3,
            nudge_y = .02,
            show.legend = FALSE) +
...
#| fig.cap: "Evolución del pluriempleo. Argentina urbana, 2016-2024 (trimestres)."
#| label: fig-pluri
...
#| fig.cap: "Evolución de la capacidad de compra del ingreso total familiar medida en canastas. Argentina urbana, 2016-2024 (Anual)"
...
#| fig.cap: "Evolución de la capacidad de compra del ingreso total familiar medida en canastas. Argentina urbana, 2016-2024 (Anual). Población no pobre"
...
#| fig.cap: "Evolución de la capacidad de compra del ingreso laboral medida en canastas. Argentina urbana, 2016-2024 (Anual). Población asalariada"
...
#| fig.cap: "Evolución de la capacidad de compra del ingreso laboral medida en canastas. Argentina urbana, 2016-2024 (Anual). Población asalariada según calidad del empleo"
...
#| fig.cap: "Evolución de la capacidad de compra del ingreso laboral medida en canastas. Argentina urbana, 2016-2024 (Anual). Ramas de actividad asociadas al sector privado"
...
#| fig.cap: "Evolución de la capacidad de compra del ingreso laboral medida en canastas. Argentina urbana, 2016-2024 (Anual). Ramas de actividad asociadas al sector público"
...
#| fig.cap: "Evolución de la capacidad de compra del ingreso jubilatorio medida en canastas. Argentina urbana, 2016-2024 (Anual). Población mayor de 65 años"
...
La hipótesis planteada sugiere que la estructura ocupacional (trabajo formal) actúa como un "ascensor" que permite escapar de la pobreza. En contraste, los informales experimentan una movilidad descendente o estancada, perpetuando su exclusión. Esto refleja una circulación selectiva de la pobreza, vinculada a derechos laborales y políticas públicas segmentadas.
La pobreza circulatoria cuestiona las mediciones estáticas y demanda políticas diferenciadas.  
